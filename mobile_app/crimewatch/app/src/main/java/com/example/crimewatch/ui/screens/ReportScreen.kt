...
fun ReportScreen(reportViewModel: ReportViewModel = viewModel()) {
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            trailingIcon = {
                IconButton(onClick = { datePickerDialog.show() }) {
                    Icon(painter = painterResource(id = R.drawable.ic_calendar), contentDescription = "Select Date")
                }
            },
        ...
        val timePickerDialog = TimePickerDialog(
            context,
            { _, selHour, selMinute ->
                occurrenceTime = String.format("%02d:%02d", selHour, selMinute)
            },
            hour, minute, true
        )
        ...
        OutlinedTextField(
            ...
            trailingIcon = {
                IconButton(onClick = { timePickerDialog.show() }) {
                    Icon(painter = painterResource(id = R.drawable.ic_clock), contentDescription = "Select Time")
                }
            },
            modifier = Modifier.fillMaxWidth()
        )
        ...
        Button(
            onClick = {
                if (selectedCrimeType == null || selectedLocation == null || description.isBlank()) {
                    ...
                    reportViewModel.submitReport(
                        ...
                        reportType = "sighting", // Hardcoded for now
                        latitude = null, // Not in UI
                        longitude = null, // Not in UI
